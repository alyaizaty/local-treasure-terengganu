...
<%
    ...
    Integer targetLocationIdObj = (Integer) request.getAttribute("targetLocationId");
    ...
    int targetLocationId = targetLocationIdObj;
    ...
    int totalReviews = business.get("total_reviews") != null ? (Integer) business.get("total_reviews") : 0;
